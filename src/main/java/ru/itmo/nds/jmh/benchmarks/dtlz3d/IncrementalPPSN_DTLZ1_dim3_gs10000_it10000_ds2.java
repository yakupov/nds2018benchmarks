 ...
 */
public class IncrementalPPSN_DTLZ1_dim3_gs10000_it10000_ds2 extends AbstractDtlzZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_DTLZ1_dim3_gs10000_it10000_ds2.class
                .getResourceAsStream("dtlz1_dim3_gen10000_iter10000_dataset2.json")) {
