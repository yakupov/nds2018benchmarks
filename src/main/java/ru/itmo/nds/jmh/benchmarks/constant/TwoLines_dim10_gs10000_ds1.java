...
public class TwoLines_dim10_gs10000_ds1 extends AbstractConstant1GenBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws IOException {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = TwoLines_dim10_gs10000_ds1.class
                .getResourceAsStream("twoLines_dim10_gen10000.json")) {
