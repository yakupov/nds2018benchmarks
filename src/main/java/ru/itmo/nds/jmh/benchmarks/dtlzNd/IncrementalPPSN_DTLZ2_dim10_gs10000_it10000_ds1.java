 ...
 */
public class IncrementalPPSN_DTLZ2_dim10_gs10000_it10000_ds1 extends AbstractDtlzZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_DTLZ2_dim10_gs10000_it10000_ds1.class
                .getResourceAsStream("dtlz2_dim10_gen10000_iter10000_dataset1.json")) {
