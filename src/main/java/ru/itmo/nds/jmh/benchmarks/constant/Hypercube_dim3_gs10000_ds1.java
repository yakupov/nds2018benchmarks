...
public class Hypercube_dim3_gs10000_ds1 extends AbstractConstant3GenBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws IOException {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = Hypercube_dim3_gs10000_ds1.class
                .getResourceAsStream("uniform_dim3_gen10000.json")) {
