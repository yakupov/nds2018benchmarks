...
public class TwoPlanes_dim20_gs10000_ds1 extends AbstractConstant3GenBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws IOException {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = TwoPlanes_dim20_gs10000_ds1.class
                .getResourceAsStream("twoLayers_dim20_gen10000.json")) {
