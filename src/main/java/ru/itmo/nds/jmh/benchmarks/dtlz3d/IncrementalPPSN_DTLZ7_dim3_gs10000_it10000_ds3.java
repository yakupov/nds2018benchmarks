 ...
 */
public class IncrementalPPSN_DTLZ7_dim3_gs10000_it10000_ds3 extends AbstractDtlzZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_DTLZ7_dim3_gs10000_it10000_ds3.class
                .getResourceAsStream("dtlz7_dim3_gen10000_iter10000_dataset3.json")) {
