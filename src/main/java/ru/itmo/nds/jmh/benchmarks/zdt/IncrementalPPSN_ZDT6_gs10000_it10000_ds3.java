 ...
 */
public class IncrementalPPSN_ZDT6_gs10000_it10000_ds3 extends AbstractZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_ZDT6_gs10000_it10000_ds3.class
                .getResourceAsStream("zdt6_gen10000_iter10000_dataset3.json")) {
