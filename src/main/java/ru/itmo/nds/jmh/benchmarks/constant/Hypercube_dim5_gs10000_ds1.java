...
public class Hypercube_dim5_gs10000_ds1 extends AbstractConstant3GenBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws IOException {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = Hypercube_dim5_gs10000_ds1.class
                .getResourceAsStream("uniform_dim5_gen10000.json")) {
