 ...
 */
public class IncrementalPPSN_ZDT3_gs10000_it10000_ds1 extends AbstractZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_ZDT3_gs10000_it10000_ds1.class
                .getResourceAsStream("zdt3_gen10000_iter10000_dataset1.json")) {
