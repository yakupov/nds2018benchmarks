 ...
 */
public class IncrementalPPSN_ZDT2_gs10000_it10000_ds2 extends AbstractZdtBenchmark {
    @Override
    protected FrontStorage loadFrontsFromResources() throws Exception {
        final FrontStorage frontStorage = new FrontStorage();
        try (InputStream is = IncrementalPPSN_ZDT2_gs10000_it10000_ds2.class
                .getResourceAsStream("zdt2_gen10000_iter10000_dataset2.json")) {
